...
void Special_Keys (int key, int x, int y)
{
    switch (key) {
       ...
       case GLUT_KEY_LEFT :  viewangle -= 1;  break;
       case GLUT_KEY_RIGHT:  viewangle += 1;  break;
       case GLUT_KEY_UP   :  tippangle -= 1;  break;
       case GLUT_KEY_DOWN :  tippangle += 1;  break;
...
void Draw_Box (void)
{
    glBegin (GL_QUADS);
      ...
      glColor3f  ( 0.0,  1.0, 0.0);     // Front - green
